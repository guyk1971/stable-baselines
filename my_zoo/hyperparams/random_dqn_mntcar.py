...
# for acting randomly, set exploration to be 1.0 for the entire training period:
agent_params.exploration_fraction = 1.0
agent_params.exploration_final_eps= 1.0
