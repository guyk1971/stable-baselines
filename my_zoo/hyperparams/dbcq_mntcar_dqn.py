...
batch_expert_params.exploration_fraction=0.5      # explore for the whole timesteps
batch_expert_params.exploration_final_eps=0.1     # and always (i.e. with prob eps=1.0 ) explore
...
experiment_params.batch_expert_steps_to_record = 500      # number of steps to rollout into the buffer
# if using non-random agent (see batch_expert_params), set its training period
# else, the following parameter is ignored
# experiment_params.batch_expert_n_timesteps = int(2e5)       # n_timesteps to train the expert before starting to rollout
#                                                             # not relevant for random

experiment_params.batch_expert_n_timesteps = int(2e3)       # n_timesteps to train the expert before starting to rollout
