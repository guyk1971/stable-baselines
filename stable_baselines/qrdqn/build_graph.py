...
def build_train(q_func, ob_space, ac_space, optimizer, sess, reward_model=None, grad_norm_clipping=None,
    ...
    with tf.variable_scope(scope, reuse=reuse):
        ...
        act_f, obs_phs,n_atoms = build_act(q_func, ob_space, ac_space, stochastic_ph, update_eps_ph, sess)
    ...
    return act_f, train, update_target, step_model, ope_reward_model, {'quant_values':quant_values}
